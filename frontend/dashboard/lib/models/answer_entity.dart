...
class SubmissionEntity {
  ...
  SubmissionEntity({required this.answers, required this.surveyId, required this.collectorId});
      ...
      answers: List<AnswerEntity>.from(
        map['answers']?.map((answer) {
              return switch (getType(answer['type'])) {
                ...
                QuestionType.multipleChoice => MultipleChoiceAnswer.fromMap(answer),
