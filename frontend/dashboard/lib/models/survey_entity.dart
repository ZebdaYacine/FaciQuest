...
class SurveyEntity extends Equatable {
  ...
  List<Object?> get props {
    return [name, description, languages, topics, likertScale, status, questions, submissions, collectors];
  }
...
enum LikertScale {
  ...
  static LikertScale fromMap(String name) {
    return LikertScale.values.firstWhere((element) => element.name == name, orElse: () => LikertScale.twoPoints);
  }
}
