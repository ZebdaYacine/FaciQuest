  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetAudience': {
        ...
        'gender': gender?.name,
        'ageRange': {'start': ageRange?.start.toInt() ?? 0, 'end': ageRange?.end.toInt() ?? 120},
  ...
  factory CollectorEntity.fromMap(Map<String, dynamic> map) {
    ...
    return CollectorEntity(
      ...
      createdDate: map['createdDate'] != null
          ? DateTime.fromMillisecondsSinceEpoch((map['createdDate'] as num).toInt())
          : null,
      ...
      cities: targetAudience?['cities'] != null
          ? List<City>.from((targetAudience!['cities'] as List).map((x) => City.fromMap(x as Map<String, dynamic>)))
          : [],
...
class TargetingCriteria extends Equatable {
  const TargetingCriteria({this.id = '', this.category, this.title = '', this.description, this.choices = const []});
  final String id;
  ...
  static List<TargetingCriteria> dummy() {
    return [
      TargetingCriteria(
        ...
        choices: [
          CriteriaChoices(id: ObjectId().hexString, title: 'Elementary School'),
          CriteriaChoices(id: ObjectId().hexString, title: 'High School'),
          CriteriaChoices(id: ObjectId().hexString, title: 'College'),
          CriteriaChoices(id: ObjectId().hexString, title: 'University'),
        ],
      ),
      TargetingCriteria(
        id: ObjectId().hexString,
        ...
        choices: [
          CriteriaChoices(id: ObjectId().hexString, title: 'Single'),
          CriteriaChoices(id: ObjectId().hexString, title: 'Married'),
          CriteriaChoices(id: ObjectId().hexString, title: 'Divorced'),
          CriteriaChoices(id: ObjectId().hexString, title: 'Widowed'),
        ],
      ),
      TargetingCriteria(
        id: ObjectId().hexString,
        ...
        choices: [
          CriteriaChoices(id: ObjectId().hexString, title: 'No children'),
          CriteriaChoices(id: ObjectId().hexString, title: 'Has children'),
        ],
      ),
      TargetingCriteria(
        id: ObjectId().hexString,
        ...
        choices: [
          CriteriaChoices(id: ObjectId().hexString, title: 'American Indian or Alaska Native'),
          CriteriaChoices(id: ObjectId().hexString, title: 'Asian'),
          CriteriaChoices(id: ObjectId().hexString, title: 'Black or African American'),
          CriteriaChoices(id: ObjectId().hexString, title: 'Native Hawaiian or Other Pacific Islander'),
          CriteriaChoices(id: ObjectId().hexString, title: 'White'),
        ],
      ),
      TargetingCriteria(
        title: 'Religion',
        ...
        choices: [
          CriteriaChoices(id: ObjectId().hexString, title: 'Islam'),
          CriteriaChoices(id: ObjectId().hexString, title: 'No religion'),
        ],
      ),
      TargetingCriteria(
        id: ObjectId().hexString,
        ...
        choices: [
          CriteriaChoices(id: ObjectId().hexString, title: 'Employed part-time'),
          CriteriaChoices(id: ObjectId().hexString, title: 'Employed full-time'),
          CriteriaChoices(id: ObjectId().hexString, title: 'Unemployed'),
          CriteriaChoices(id: ObjectId().hexString, title: 'Retired'),
        ],
      ),
      TargetingCriteria(
        id: ObjectId().hexString,
        ...
        choices: [
          CriteriaChoices(id: ObjectId().hexString, title: 'Entry-level'),
          CriteriaChoices(id: ObjectId().hexString, title: 'Mid-level'),
          CriteriaChoices(id: ObjectId().hexString, title: 'Senior-level'),
          CriteriaChoices(id: ObjectId().hexString, title: 'Manager'),
          CriteriaChoices(id: ObjectId().hexString, title: 'Director'),
        ],
      ),
    ];
  }
  ...
  factory TargetingCriteria.fromMap(Map<String, dynamic> map) {
    return TargetingCriteria(
      ...
      choices: List<CriteriaChoices>.from(
        (map['choices'] as List).map<CriteriaChoices>((x) => CriteriaChoices.fromMap(x as Map<String, dynamic>)),
      ),
    );
  }
  ...
  @override
  List<Object?> get props {
    return [id, category, title, description, choices];
  }
}
...
class CriteriaChoices extends Equatable {
  ...
  const CriteriaChoices({required this.id, required this.title});

  CriteriaChoices copyWith({String? id, String? title}) {
    return CriteriaChoices(id: id ?? this.id, title: title ?? this.title);
  }
  ...
  factory CriteriaChoices.fromMap(Map<String, dynamic> map) {
    return CriteriaChoices(id: map['id'] as String, title: map['title'] as String);
  }
