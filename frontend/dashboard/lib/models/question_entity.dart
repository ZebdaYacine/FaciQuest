...
sealed class QuestionEntity extends Equatable {
  ...
  @override
  List<Object?> get props => [title, type, order, isRequired];
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{'id': id, 'title': title, 'order': order, 'type': type.name, 'isRequired': isRequired};
  }
  ...
  QuestionEntity copyWith({String? title, int? order, QuestionType? type});
  ...
  static List<QuestionEntity> dummyList() {
    return [
      ...
      ShortAnswerQuestion(id: ObjectId().hexString, title: 'Short Answer', order: 5, type: QuestionType.shortAnswer),
      CommentBoxQuestion(id: ObjectId().hexString, title: 'Comment Box', order: 6, type: QuestionType.commentBox),
      SliderQuestion(id: ObjectId().hexString, title: 'Slider', order: 7, type: QuestionType.slider, min: 0, max: 10),
      DateTimeQuestion(id: ObjectId().hexString, title: 'Date / Time', order: 8, type: QuestionType.dateTime),
      AudioRecordQuestion(id: ObjectId().hexString, title: 'Audio Record', order: 9, type: QuestionType.audioRecord),
      MatrixQuestion(
        id: ObjectId().hexString,
        title: 'Matrix',
        order: 10,
      ...
      ImageChoiceQuestion(
        ...
        title: 'Image Choice',
        choices: [
          ImageChoice(id: ObjectId().hexString, altText: 'Choice 1', url: 'https://picsum.photos/id/237/200/300'),
          ImageChoice(id: ObjectId().hexString, altText: 'Choice 2', url: 'https://picsum.photos/id/238/200/300'),
          ImageChoice(id: ObjectId().hexString, altText: 'Choice 3', url: 'https://picsum.photos/id/239/200/300'),
        ],
        order: 11,
        type: QuestionType.imageChoice,
      ),
      NameQuestion(id: ObjectId().hexString, title: 'Name', order: 12, type: QuestionType.nameType),
      ...
      PhoneQuestion(id: ObjectId().hexString, title: 'Phone Number', order: 14, type: QuestionType.phoneNumber),
      AddressQuestion(id: ObjectId().hexString, title: 'Address', order: 15, type: QuestionType.address),
      TextQuestion(id: ObjectId().hexString, title: 'Text', order: 16, type: QuestionType.text),
      ImageQuestion(
        id: ObjectId().hexString,
        title: 'Image',
        image: ImageChoice(id: ObjectId().hexString, url: 'https://picsum.photos/200/300', altText: 'Image'),
        order: 17,
...
final Map<String, List<List<String>>> scaleOptions = {
  'Agree - Disagree': [
    ...
    ['Strongly agree', 'Agree', 'Neither agree nor disagree', 'Disagree', 'Strongly disagree'], // Scale 5
    [
      'Strongly agree',
      'Agree',
      'Somewhat agree',
  ...
  'Clear - Not clear': [
    ['Extremely clear', 'Very Clear', 'Somewhat clear', 'Not so clear', 'Not at all clear'],
  ],
  'Helpful - Not helpful': [
  ...
  'Desirable - Not desirable': [
    ['Extremely desirable', 'Very Desirable', 'Somewhat desirable', 'Not so desirable', 'Not at all desirable'],
  ],
  ...
  'Attentive - Not attentive': [
    ['Extremely attentive', 'Very Attentive', 'Somewhat attentive', 'Not so attentive', 'Not at all attentive'],
  ],
  'Early - Late': [
  ...
  'Recent Experience': [
    ['In the last week', 'More than a week, less than a month', 'More than a month ago'],
  ],
};
...
List<String> getScaleOptions(String? scaleName, int? scaleSize) {
  if (scaleOptions.containsKey(scaleName)) {
    ...
    return option.firstWhere((scale) => scale.length == scaleSize, orElse: () => option.lastOrNull ?? []);
  }
  return [];
}
